...
<head>
    ...
    <style>
        body {
            ...
            background-image: linear-gradient(135deg,rgb(54, 54, 54) 0%,rgb(58, 59, 87) 100%);
            margin: 0;
            padding-top: 60px;
...
<body>
    ...
    <div class="header d-flex justify-content-between align-items-center px-4">
        ...
        <a href="logout.php" class="d-flex justify-content-between align-items-center">Sair</a>
    </div>
